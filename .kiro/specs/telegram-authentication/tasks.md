...
- [x] 2. Backend: Telegram hash verification service
  ...
  - [x]* 2.2 Write unit tests for TelegramHashVerifier
...
- [x] 4. Backend: Telegram authentication service
  ...
  - [x]* 4.2 Write unit tests for TelegramAuthService
...
- [x] 6. Backend: Auth controller endpoints
  ...
  - [x]* 6.3 Write integration tests for Telegram endpoints
...
- [x]* 11.4 Write unit tests for AuthProvider Telegram methods
...
- [x] 12. Frontend: Login screen UI
  ...
  - [x]* 12.3 Write widget tests for login screen
    - Test Telegram button renders correctly
    - Test button tap triggers signInWithTelegram
    - Test error dialog displays on failure
    - _Requirements: 12.4_

  - [x] 12.4 Add "Continue with Telegram" button to registration flow
    - Add Telegram CTA to patient registration screen
    - Add Telegram CTA to doctor registration screen
    - Reuse Telegram auth error handling with localized messages
    - _Requirements: 1.1, 5.3, 10.5_
...
- [ ] 15. Integration: End-to-end flow testing
  ...
  - [x] 15.2 Test backward compatibility
