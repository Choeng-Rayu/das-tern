...
class _VitalTrendScreenState extends State<VitalTrendScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final vitals = provider.vitals
        .where((v) => v.vitalType == widget.vitalType)
        .toList()
                    ...
                    titlesData: FlTitlesData(
                      ...
                      bottomTitles: AxisTitles(
                        sideTitles: SideTitles(
                          ...
                          interval: (vitals.length / 5).ceilToDouble().clamp(1, double.infinity),
                        ),
                      ),
      ...
      child: ListTile(
        leading: Container(
          ...
          decoration: BoxDecoration(
            color: vital.isAbnormal ? AppColors.alertRed : AppColors.successGreen,
